...
<body class="loading-overlay-showing" data-loading-overlay>
        ...
        <div class="body blog-bg">
            <header id="header" class="header-narrow header-full-width" data-plugin-options="{'stickyEnabled': true, 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyStartAt': 0, 'stickySetTop': '0'}">
                <div class="header-body header-column-center">
                    <div class="header-container container">
                        <div class="header-row">
                            <div class="header-column header-column-center">
                                <div class="header-logo ">
                                     <a href="http://ttclub.test/">
                                                    <img alt="Porto" width="90" height="80" src="/img/todotuclub.png">
                                                    <img alt="Porto" width="180" height="80" src="/img/clubes.png">
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="header-row">
                                    <div class="header-nav">
                                        ...
                                        <div class="header-nav-main header-nav-main-effect-1 header-nav-main-sub-effect-1 collapse">
                                             ...
                                             <nav>
                                               <?php require_once('layout_nav.php'); ?>
                                            </nav>
                                        </div>
                                    </div>
                                </div>
